...
from Auxiliary.benchmarks.seedv.scripts import run_seedv_reve_official_finetune as base
...
def main():
    ...
    parser.add_argument(
        "--config",
        default="Auxiliary/benchmarks/seedv/configs/seedv_reve_headband.yaml",
    )

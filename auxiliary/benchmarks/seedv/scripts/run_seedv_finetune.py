...
Usage:
    python auxiliary/benchmarks/seedv/scripts/run_seedv_finetune.py \
        --config auxiliary/benchmarks/seedv/configs/seedv_finetune.yaml
    python auxiliary/benchmarks/seedv/scripts/run_seedv_finetune.py \
        --config auxiliary/benchmarks/seedv/configs/seedv_finetune.yaml --max-epochs 2 --folds 1
"""
...
def main():
    ...
    parser.add_argument(
        "--config",
        default="auxiliary/benchmarks/seedv/configs/seedv_finetune.yaml",
